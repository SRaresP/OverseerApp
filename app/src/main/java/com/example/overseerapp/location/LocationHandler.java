...
public class LocationHandler {
	...
	public static String AddLocation(String locationHistory, String locationToAdd) throws IllegalArgumentException {
		...
		{
			if (locationHistory.charAt(i) == OverseerApp.LOC_HISTORY_SEPARATOR)
			{
				++locationsCount;
		...
		locationToAdd += OverseerApp.LOC_HISTORY_SEPARATOR;
	...
	public static String getLocationByIndex(final @NonNull String locationHistory, int locationIndex) {
		return locationHistory.split(String.valueOf(OverseerApp.LOC_HISTORY_SEPARATOR))[locationIndex];
	}

	public static String getLastLocation(final @NonNull String locationHistory) {
		return locationHistory.split(String.valueOf(OverseerApp.LOC_HISTORY_SEPARATOR))[0];
	}
}
